...
var gameState=PLAY;
function preload (){
 playerImage=loadImage("star.png") 
 groundImage=loadImage("track(2).png")
 backgroundImage=loadImage("hurdle.jpg")
 obstaclesImage=loadImage("hurdle.png")
 fur23Image=loadImage("hurdle.png")
 shampooImage=loadImage("hurdle.jpg")
...
function draw() {
  ...
  text(" beware of its hurdles we all know that you dont",20,50);
  text(" have a limit to jump but jump to high the satlites",20,70);
  text("and rockets will kill you jump to low and the ",20,90);
  text("hurdles will kill  you",20,110);
